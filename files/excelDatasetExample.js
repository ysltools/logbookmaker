let dataObjExample = 
{
  ...
  wsContents:{
    "관외대출":{
      title:"📓\n관외대출\n현황",
      cols:["다산자료실","퇴계자료실","어린이자료실","전자정보실","보존서고","어울림자료실","스마트도서관","동네서점"]
    },
    "이용자":{
      title:"👪 이용자 현황",
      maxRow:14,
      rows:["다산자료실","퇴계자료실","어린이자료실","전자정보실","어울림자료실","스마트도서관","동네서점","강좌 및 행사"],
      cols:["영유아","학생","일반"]
    },
    "야간":{
      title:"🌙 야간 이용 현황",
    ...
    "소장자료":{
      title:"📕\n소장자료\n현황",
      자료실:["다산자료실","퇴계자료실","어린이자료실","보존서고","어울림자료실","스마트도서관"],
